...
Shape of burned area in July 2022 on Kras(Slovenia, Italy) on pre-fire scene
### Imagery:
...
<br><sup>Downscaling=Nearest Neighbour; User defined Cell Size(of other bands); default coordinates; Fit nodes</sup></br>
